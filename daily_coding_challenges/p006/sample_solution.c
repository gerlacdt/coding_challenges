/* C/C++ Implementation of Memory efficient Doubly Linked List. In
order to save memory we only store one pointer in a list node. With
this single pointer you still can reference both ways - previous and
next.*/
#include <stdio.h>
#include <stdlib.h>
#include <inttypes.h>
